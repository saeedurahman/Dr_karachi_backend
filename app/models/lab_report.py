...
class LabReport(TimestampMixin, Base):
    ...
    # Internal private storage path (e.g. reports/{patient_id}/{uuid}.pdf) â€” signed URL generated on demand
    ...
    # Staff who uploaded â€” stored as UUID; nullable if auto-generated
